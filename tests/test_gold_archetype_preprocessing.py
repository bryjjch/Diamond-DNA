...
from src.data_pipeline.gold.gold_archetype_preprocessing import (
...
def test_build_silver_to_gold_preprocessing_writes_gold_and_metadata(monkeypatch):
    ...
    monkeypatch.setattr("src.data_pipeline.gold.gold_archetype_preprocessing.read_parquet_from_s3", fake_read)
    monkeypatch.setattr("src.data_pipeline.gold.gold_archetype_preprocessing.write_parquet_to_s3", fake_write)
    monkeypatch.setattr("src.data_pipeline.gold.gold_archetype_preprocessing.get_s3_client", lambda: _DummyS3())
