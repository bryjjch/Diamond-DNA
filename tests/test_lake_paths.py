...
from src.common.s3_interaction import (
    DEFENCE_OAA_PARQUET,
...
def test_gold_archetype_clustering_keys():
    ...
    assert gold_archetype_cluster_labels_key("gold/statcast", "batter", 2024) == (
        "gold/statcast/batter/year=2024/cluster_labels.json"
    )
